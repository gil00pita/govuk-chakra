...
export const Default: Story = {
	render: () => (
		<Field.Root>
			...
			<Select.Content>
				<Select.Item item='option1'>Option 1</Select.Item>
				<Select.Item item='option2'>Option 2</Select.Item>
				<Select.Item item='option3'>Option 3</Select.Item>
			</Select.Content>
		</Field.Root>
	),
}
	...
	render: () => (
      ...
      defaultValue={["GB"]}
			>
				...
				<Select.Content>
					<Select.Item item='GB'>United Kingdom</Select.Item>
					<Select.Item item='US'>United States</Select.Item>
					<Select.Item item='FR'>France</Select.Item>
					<Select.Item item='DE'>Germany</Select.Item>
					<Select.Item item='ES'>Spain</Select.Item>
					<Select.Item item='IT'>Italy</Select.Item>
				</Select.Content>
			</Select.Root>
		</Field.Root>
	),
