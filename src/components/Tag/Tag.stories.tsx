    ...
    docs: {
      description: {
        component:
          ...
          'The <Tag/> component has nine variants: `gray`, `green`, `teal`, `blue`, `purple`, `magenta`, `red`, `orange`, and `yellow`. Use the appropriate variant to convey the meaning or importance of the tag.\n\n' +
