...
const meta: Meta<QRCodeStoryArgs> = {
  title: 'Chakra Components/Data Display/QR Code',
  component: QRCode.Root as unknown as ComponentType<QRCodeStoryArgs>,
  tags: ['autodocs'],
  args: {
...
export const Default: Story = {
  render: (args) => (
    <QRCode.Root value={args.value ?? 'https://www.google.com'} size={args.size}>
      <QRCode.Frame>
        <QRCode.Pattern />
      </QRCode.Frame>
    </QRCode.Root>
