...
export const GOVUKLogo = forwardRef<SVGSVGElement, GOVUKLogoProps>(function GOVUKLogo(
  {
    title = 'GOV.UK Logo',
    titleId,
    dotColor = '#00ffe0',
  ...
  return (
    ...
    >
      ...
      <g>
        <circle fill="currentColor" cx="20" cy="17.6" r="3.7" />
        <circle fill="currentColor" cx="10.2" cy="23.5" r="3.7" />
        <circle fill="currentColor" cx="3.7" cy="33.2" r="3.7" />
        <circle fill="currentColor" cx="31.7" cy="30.6" r="3.7" />
        <circle fill="currentColor" cx="43.3" cy="17.6" r="3.7" />
        <circle fill="currentColor" cx="53.2" cy="23.5" r="3.7" />
        <circle fill="currentColor" cx="59.7" cy="33.2" r="3.7" />
        <circle fill="currentColor" cx="31.7" cy="30.6" r="3.7" />
        <path
          fill="currentColor"
      ...
      <circle fill={dotColor} className="govuk-logo-dot" cx="226" cy="36" r="7.3" />
      <path
        fill="currentColor"
